 ...
 */
function hsl (imageData, width, height, hue, saturation, lightness) {
	var hue = parseInt(hue,10)||0;
	var saturation = (parseInt(saturation,10)||0) / 100;
	var lightness = (parseInt(lightness,10)||0) / 100;
